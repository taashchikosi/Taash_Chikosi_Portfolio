...
/**
 * Interactive one-click demo (the "auto-run" the case-study page links to).
 *
 ...
 * badge. No file hunting; one click to wow. (Not auto-on-mount — that would let
 * crawlers/refreshes drain the token budget; the run is one deliberate click.)
 */
